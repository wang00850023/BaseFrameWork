...
public abstract class PopupWindowForPhotoDirListView extends PopupWindow
{
	/**
	 * 布局文件的最外层View
	 */
	...
	public PopupWindowForPhotoDirListView(View contentView, int width, int height,
			boolean focusable)
	{
	...
	public PopupWindowForPhotoDirListView(View contentView, int width, int height,
			boolean focusable, List<ImageBucket> mDatas)
	{
	...
	public PopupWindowForPhotoDirListView(View contentView, int width, int height,
			boolean focusable, List<ImageBucket> mDatas, Object... params)
	{
